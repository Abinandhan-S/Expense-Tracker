...
/// ------------------------------------------------------------
/// Expense Card with Auto-Reduction Info
/// ------------------------------------------------------------
class ExpenseCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int totalDays = 0;
    int reducedDays = expense.reducedDaysCount ?? 0;
    int remainingDays = 0;

    if (expense.autoReduceEnabled &&
        expense.dailyReduce != null &&
        expense.totalBudget != null &&
        expense.dailyReduce! > 0) {
      totalDays = (expense.totalBudget! / expense.dailyReduce!).ceil();
      remainingDays = (totalDays - reducedDays).clamp(0, totalDays);
    }
            ...
            subtitle: Column(
              ...
              children: [
                ...
                if (expense.autoReduceEnabled &&
                  ...
                  Text(
                    'Auto reducing ₹${expense.dailyReduce?.toStringAsFixed(0) ?? "0"}/day',
                  ...
                  Text(
                    '$reducedDays days deducted • $remainingDays days remaining',
                    style: const TextStyle(
                  ...
                  Padding(
                    ...
                    child: LinearProgressIndicator(
                      value: totalDays > 0
                          ? (reducedDays / totalDays).clamp(0.0, 1.0)
                          : 0,
